...
<br>
        ...
        <div class="row activity text-center">
            ...
            <div class="col-md act">
                <br><br>
                <img src="img/moneytransfer.jpg" class="img-fluid">
                <br><br>
                <a href="transfermoney.php"><button>Transfer Money</button></a>
            </div>
            <div class="col-md act">
                <img src="img/transactionhistory.jpg" class="img-fluid">
                <br>
   ...
   <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Rashmi parmar</b> <br> For the Project of  <b>The Sparks Foundation</b></p>
    </footer>
